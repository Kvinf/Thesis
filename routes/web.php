...
Route::get('/editapi/{id}', [APIListController::class, 'showEditApiForm'])->name('editapi')->middleware('auth');
...
Route::post('editapi', [APIListController::class, 'editApi'])->name('editapipost');
